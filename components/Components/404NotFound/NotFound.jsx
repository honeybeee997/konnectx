      ...
      <div id="not-found-wrapper">
        <div>
          <div className="container">
            <div className="row">
              <div className="col-sm-12 col-md-12 mt-5 mb-5 not-found">
                <svg
                  width="100%"
                  viewBox="0 0 636 324"
                  fill="none"
                ...
                >
                  ...
                  <defs>
                    ...
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#000034" />
                      <stop offset="1" stopColor="#008ddf" />
                    </linearGradient>
                    <linearGradient
                      id="paint7_linear"
                      x1="322.636"
        ...
        <h2>It appears the page you were looking for couldn't be found. </h2>
        <h4>Try going to Home Page by using the button below.</h4>
